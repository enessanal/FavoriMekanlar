...
{ //344
    ...
    fun addPlace(view:View)
    {
        ...
        if(globalName=="")
        {
            Toast.makeText(applicationContext,"Mekan İsmi Boş Bırakılamaz!", Toast.LENGTH_LONG).show()
        }
        else if(globalType=="")
        {
            Toast.makeText(applicationContext,"Mekan Türü Boş Bırakılamaz!", Toast.LENGTH_LONG).show()
        }
        else
        {
            if (globalDescription == "") globalDescription="Açıklama Yok"
